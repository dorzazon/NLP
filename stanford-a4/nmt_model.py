...
class NMT(nn.Module):
    ...
    def __init__(self, embed_size, hidden_size, vocab, dropout_rate=0.2):
        ...
        self.encoder = torch.nn.LSTM(embed_size, hidden_size, self.num_of_layers, bias=True, bidirectional=True)
    ...
    def encode(self, source_padded: torch.Tensor, source_lengths: List[int]) -> Tuple[torch.Tensor, Tuple[torch.Tensor, torch.Tensor]]:
        ...
        X_packed = pack_padded_sequence(X, source_lengths, enforce_sorted=False)  # maybe change enforce_sorted
    ...
    def decode(self, enc_hiddens: torch.Tensor, enc_masks: torch.Tensor,
        ...
        for Y_t in torch.split(Y, 1):
            ...
            dec_state, combined_output, e_t = self.step(Y_t, dec_state, enc_hiddens, enc_hiddens_proj, enc_masks)
    ...
    def step(self, Ybar_t: torch.Tensor,
        ...
        e_t = torch.bmm(enc_hiddens_proj, torch.unsqueeze(dec_state[0], -1))
        ...
        a_t = torch.bmm(torch.transpose(enc_hiddens, 1, 2), torch.unsqueeze(alpha_t, -1))
