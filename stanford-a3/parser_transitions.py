...
class PartialParse(object):
    ...
    def parse_step(self, transition):
        ...
        if transition == 'S':  # shift
            ...
            self.dependencies.append((self.stack[-2], self.stack[-1])) # add dependency to list
            self.stack.pop(-1)  # removes second item from stack
        elif transition == 'LA':  # left arc
            self.dependencies.append((self.stack[-1], self.stack[-2]))  # add dependency to list
            self.stack.pop(-2)  # removes second item from stack
        ### END YOUR CODE
